...
class NUFFT3(FourierBase):
    ...
    def __init__(self, samples, shape, normalized=False):
    ...
    def op(self, img):
        ...
        """
        return self.plan.forward(img) / self.norm_const
    ...
    def adj_op(self, x):
        ...
        """
        return self.plan.adjoint(x) * np.prod(self.plan.Kd) / self.norm_const
