...
See pysap documentation for more informations about the install options. As of v0.0.6 of pysap, the following will install only what is necessary (from pysap setup.py directly):
